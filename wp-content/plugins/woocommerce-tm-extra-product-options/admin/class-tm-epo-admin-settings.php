...
if ( class_exists( 'WC_Settings_Page' ) ) {
	...
	class TM_EPO_ADMIN_SETTINGS extends WC_Settings_Page {
		...
		public function __construct() {
			...
			add_action( 'woocommerce_admin_settings_sanitize_option_' . 'tm_epo_css_code', array( $this, 'tm_return_raw' ), 10, 3 );
			add_action( 'woocommerce_admin_settings_sanitize_option_' . 'tm_epo_js_code', array( $this, 'tm_return_raw' ), 10, 3 );
		}
