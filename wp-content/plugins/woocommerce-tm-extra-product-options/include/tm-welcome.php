...
class TM_EPO_Admin_Welcome {
	...
	/**
	 * TM_EPO_Admin_Welcome constructor.
	 */
	...
	public function admin_head() {
		...
		if ( !empty( $_GET['page'] ) && $_GET['page'] == 'tc-about' ) {
			?>
            <link href='<?php echo TM_EPO_PLUGIN_URL . '/assets/css/font-awesome.min.css'; ?>' rel='stylesheet'
                  type='text/css'>
            <link href='https://fonts.googleapis.com/css?family=Roboto:400,100,100italic,300italic,300,400italic,500,500italic,700,700italic,900,900italic&subset=latin,cyrillic-ext,greek-ext,greek,vietnamese,latin-ext,cyrillic'
	...
	private function welcome_header() {
        ...
        <div class="tm-logo"><span class="tm-logo-text"><span class="tm-logo-text-e">E</span><span
                        class="tm-logo-text-po">PO</span></span><span
                    class="tm-version"><?php printf( __( 'Version %s', 'woocommerce' ), TM_EPO_VERSION ); ?></span>
        </div>

        <p class="tm-actions">
            <a href="<?php echo admin_url( 'admin.php?page=wc-settings&tab=tm_extra_product_options' ); ?>"
               class="button button-primary"><?php _e( 'Settings', 'woocommerce-tm-extra-product-options' ); ?></a>
            <a href="<?php echo esc_url( 'http://epo.themecomplete.com/documentation/woocommerce-tm-extra-product-options/index.html' ); ?>"
               class="docs button button-primary"><?php _e( 'Documentation', 'woocommerce-tm-extra-product-options' ); ?></a>
            <a href="<?php echo esc_url( 'http://support.themecomplete.com/' ); ?>"
               class="docs button button-primary"><?php _e( 'Support', 'woocommerce-tm-extra-product-options' ); ?></a>
        ...
        <div class="wrap about-wrap">
            ...
            <div class="changelog">
                <div class="tc-feature-wrap">
                    <div>
                        <img class="tc-featured-img"
                             src="<?php echo TM_EPO_PLUGIN_URL . '/assets/images/about-1.png'; ?>"/>
            ...
            <p><?php _e( 'For any problems feel free to contact us at the', 'woocommerce-tm-extra-product-options' ); ?>
                <a href="<?php echo esc_url( 'http://support.themecomplete.com/' ); ?>"><?php _e( 'Support forum', 'woocommerce-tm-extra-product-options' ); ?></a>.
            </p>
