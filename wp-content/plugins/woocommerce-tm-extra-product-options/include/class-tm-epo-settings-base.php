	...
	public function _get_setting_display( $setting, $label ) {
		return array(
			...
			array(
				...
				'desc'    => __( 'Check to enable the display of extra options on the shop page and category view. This setting is theme dependent and some aspect may not work as expected.', 'woocommerce-tm-extra-product-options' ),
	...
	public function _get_setting_cart( $setting, $label ) {
		return array(
			...
			array(
				...
				'desc'    => '<span>' . __( 'Enable this if product have a lot of options.', 'woocommerce-tm-extra-product-options' ) . '</span>',
	...
	public function _get_setting_global( $setting, $label ) {
		return array(
			...
			array(
				...
				//'desc_tip'        => '<span>'.__( '', 'woocommerce-tm-extra-product-options' ).'</span>',
