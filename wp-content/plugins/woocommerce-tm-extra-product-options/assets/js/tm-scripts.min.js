...
a.data.wc27_zoom_target&&(a.data.wc27_zoom_target.tc_reset_attr("data-thumb"),c.find(".flex-control-nav li:eq(0) img").tc_reset_attr("src")),d.tc_reset_attr("href"),d.tc_reset_attr("title")}}(jQuery);