...
body.bfwc-body form.braintree-donation #loading {
	position: absolute;
	left: calc(50% - 100px);
	top: calc(50% - 25px);
	z-index: 9999
...
body.bfwc-body form.braintree-donation .uil-ripple {
	position: absolute;
	left: calc(50% - 90px);
	top: calc(50% - 90px);
	opacity: .5;
...
body.bfwc-body form.braintree-donation .ld-l {
	opacity: 0;
	animation: ld-in 3s 0.0s ease infinite;
}

body.bfwc-body form.braintree-donation .ld-o {
	opacity: 0;
	animation: ld-in 3s 0.1s ease infinite;
}

body.bfwc-body form.braintree-donation .ld-a {
	opacity: 0;
	animation: ld-in 3s 0.2s ease infinite;
}

body.bfwc-body form.braintree-donation .ld-d {
	opacity: 0;
	animation: ld-in 3s 0.3s ease infinite;
}

body.bfwc-body form.braintree-donation .ld-i {
	opacity: 0;
	animation: ld-in 3s 0.4s ease infinite;
}

body.bfwc-body form.braintree-donation .ld-n {
	opacity: 0;
	animation: ld-in 3s 0.5s ease infinite;
}

body.bfwc-body form.braintree-donation .ld-g {
	opacity: 0;
