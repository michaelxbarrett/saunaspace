	...
	<form method="post" class="braintree-donation">
    	<?php wp_nonce_field('braintree_donation')?>
			...
			<div class="modal-footer">
				<button class="modal-submit bfwc-donation-button" style="<?php echo $shortcode->get_button_styles()?>" id="submit_donation"><?php echo bt_manager()->get_option('donation_button_text')?></button>
				<a href="#" class="modal-close"><?php echo __('Close', 'braintree-payments' )?></a>
			</div>
		</div>
		<div class="bfwc-row">
			<button class="bfwc-donation-button" id="open_modal" style="<?php echo $shortcode->get_modal_button_styles()?>"><?php echo bt_manager()->get_option('donation_modal_button_text')?></button>
		</div>
	</form>
</div>
