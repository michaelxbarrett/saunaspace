...
<style>
body.bfwc-body .bfwc-new-payment-method-container .pacman-overlay{
	width: 100%;
	height: 100%;
...
body.bfwc-body .bfwc-new-payment-method-container .pacman:before, 
body.bfwc-body .bfwc-new-payment-method-container .pacman:after {
  z-index: 9991;
  content: '';
  position: absolute;
  background: #FFC107;
...
body.bfwc-body .bfwc-new-payment-method-container .pacman-dot {
  z-index: 999;
  position: absolute;
  left: 50%;
  top: 50%;
