...
body.bfwc-body .bfwc-new-payment-method-container #loading {
	position: absolute;
	left: calc(50% - 100px);
	top: calc(50% - 25px);
	z-index: 9999
...
body.bfwc-body .bfwc-new-payment-method-container .uil-ripple {
	position: absolute;
	left: calc(50% - 90px);
	top: calc(50% - 90px);
	opacity: .5;
...
body.bfwc-body .bfwc-new-payment-method-container .ld-l {
	opacity: 0;
	animation: ld-in 3s 0.0s ease infinite;
}

body.bfwc-body .bfwc-new-payment-method-container .ld-o {
	opacity: 0;
	animation: ld-in 3s 0.1s ease infinite;
}

body.bfwc-body .bfwc-new-payment-method-container .ld-a {
	opacity: 0;
	animation: ld-in 3s 0.2s ease infinite;
}

body.bfwc-body .bfwc-new-payment-method-container .ld-d {
	opacity: 0;
	animation: ld-in 3s 0.3s ease infinite;
}

body.bfwc-body .bfwc-new-payment-method-container .ld-i {
	opacity: 0;
	animation: ld-in 3s 0.4s ease infinite;
}

body.bfwc-body .bfwc-new-payment-method-container .ld-n {
	opacity: 0;
	animation: ld-in 3s 0.5s ease infinite;
}

body.bfwc-body .bfwc-new-payment-method-container .ld-g {
	opacity: 0;
