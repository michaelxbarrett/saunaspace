	...
	<div id="dynamic-card-form" class="scale-down">
		...
		<div class="cardinfo-wrapper">
			<div class="cardinfo-exp-date">
				<label class="cardinfo-label" for="bfwc-expiration-date"><?php bwc_custom_form_text('card_expiration_date_label', __('Exp Date', 'braintree-payments'))?></label>
				<div class='input-wrapper' id="bfwc-expiration-date" data-placeholder="<?php bwc_custom_form_text('card_expiration_date_placeholder', __('MM / YY', 'braintree-payments'))?>"></div>
			</div>
			<?php if(bwc_cvv_field_enabled()):?>
				<div class="cardinfo-cvv">
				<label class="cardinfo-label" for="bfwc-cvv"><?php bwc_custom_form_text('card_cvv_label', __('CVV', 'braintree-payments'))?></label>
				<div class='input-wrapper' id="bfwc-cvv" data-placeholder="<?php bwc_custom_form_text('card_cvv_placeholder', __('CVV', 'braintree-payments'))?>"></div>
			</div>
			<?php endif;?>
		</div>
		<?php if(bwc_postal_code_enabled() || bwc_display_save_payment_method()):?>
			<div class="cardinfo-wrapper">
				<?php if(bwc_postal_code_enabled()):?>
					<div class="cardinfo-postal-code">
				<label class="cardinfo-label" for="bfwc-postal-code"><?php bwc_custom_form_text('card_postal_label', __('Postal Code', 'braintree-payments'))?></label>
				<div class="input-wrapper" id="bfwc-postal-code" data-placeholder="<?php bwc_custom_form_text('card_postal_placeholder', __('Postal Code', 'braintree-payments'))?>"></div>
			</div>
				<?php endif;?>
				<?php if(bwc_display_save_payment_method()):?>
					<div class="cardinfo-save-card">
				<label class="cardinfo-label"><?php bwc_custom_form_text('card_save_label', __('Save', 'braintree-payments'))?></label>
