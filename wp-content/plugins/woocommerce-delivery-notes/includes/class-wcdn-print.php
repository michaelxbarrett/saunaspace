		...
		public function __construct() {	
			...
			self::$templates = apply_filters( 'wcdn_template_registration', array(
				apply_filters( 'wcdn_template_registration_invoice', array(
					'type' => 'invoice',
					'labels' => array(
						'name' => __( 'Order Receipt', 'woocommerce-delivery-notes' ),
						'name_plural' => __( 'Order Receipts', 'woocommerce-delivery-notes' ),
						'print' => __( 'Print Order Receipt', 'woocommerce-delivery-notes' ),
						'print_plural' => __( 'Print Order Receipts', 'woocommerce-delivery-notes' ),
						'message' => __( 'Order Receipt created.', 'woocommerce-delivery-notes' ),
						'message_plural' => __( 'Order Receipts created.', 'woocommerce-delivery-notes' ),
						'setting' => __( 'Enable Order Receipts', 'woocommerce-delivery-notes' )
					)
				) ),
				apply_filters( 'wcdn_template_registration_delivery_note', array(
					'type' => 'delivery-note',
					'labels' => array(
						'name' => __( 'Pack List', 'woocommerce-delivery-notes' ),
						'name_plural' => __( 'Pack Lists', 'woocommerce-delivery-notes' ),
						'print' => __( 'Print Pack List', 'woocommerce-delivery-notes' ),
						'print_plural' => __( 'Print Pack Lists', 'woocommerce-delivery-notes' ),
						'message' => __( 'Pack List created.', 'woocommerce-delivery-notes' ),
						'message_plural' => __( 'Pack Lists created.', 'woocommerce-delivery-notes' ),
						'setting' => __( 'Enable Pack Lists', 'woocommerce-delivery-notes' )
					)
				) ),
